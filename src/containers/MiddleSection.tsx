...
const MiddleSection = () => {
    return (
        <section className="md:basis-[30%] lg:basis-[23%] md:shrink-0 lg:shrink-initial py-6 px-8 space-y-12 bg-grayBg">
            ...
            <div className="space-y-4 w-full">
                ...
                <div className="flex flex-wrap items-center justify-center space-x-2">
                    <div className="flex items-center space-x-2">
                        ...
                        <p className="text-xs xl:text-[0.6rem]">Connections</p>
                    </div>
                    <div className="flex items-center space-x-2">
                        <div className="w-3 h-3 bg-black rounded">
                        </div>
                        <p className="text-xs xl:text-[0.6rem]">Followers</p>
                    </div>
                    <div className="flex items-center space-x-2">
                        <div className="w-3 h-3 bg-blueBg rounded">
                        </div>
                        <p className="text-xs xl:text-[0.6rem]">Connect Invites</p>
                    </div>
                </div>
            </div>
        </section>
